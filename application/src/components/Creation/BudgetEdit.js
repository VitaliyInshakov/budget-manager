...
class BudgetEdit extends Component {
  ...
  componentWillMount() {
    this.props.parseBudget(this.props.selectedBudget);
  }
        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-9 offset-lg-1">
            {renderSelectList({
              ...
              value: this.props.budget.client_id,
          ...
          {this.props.budget.items.map((item, idx) => {
             return (
              <div key={item} className="row budget-item">
          ...
          <div className="col-12 col-lg-2 offset-lg-10">
            <RaisedButton
              ...
              label="Update"
              primary={true}
              onClick={this.handleClickFixClient.bind(this, this.props.budget)}
            />
          </div>
        </div>
      </div>
...
export default connect(mapStateToProps, actions)(BudgetEdit);